...
$query=  mysqli_query($con,"SELECT * FROM `hotel` WHERE `numhotel` in (SELECT `numhotel` FROM `reservation` WHERE 1)");
...
echo "<table border=\"1\"  >";
     //   echo "<caption>  </caption>";
             echo "<tr><td>  num hotel </td><td>nom  </td> <td>ville </td> <td>etoiles</td> </tr>";
...
while ($row= mysqli_fetch_assoc($query)) {//1
    ...
    $nom=$row['nom']; $num2=$row['numhotel'];  
     ...
     echo "<tr><td>  $num2 </td><td>$nom  </td> <td>$$vil</td><td>$etoil</td> "
