     ...
     !-->
      ...
      <section id="main-content">
          <section class="wrapper">
                                                ...
                                                <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="j1___2.php" novalidate="novalidate">
                              
                                              
                                              
                
     
             <label for="cname" class="control-label col-lg-2"> donne une ville   <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="vil" minlength="5" type="text" required="">
                                          </div>                          
