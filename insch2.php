...
$v2=  mysqli_query($con,"SELECT MAX(`numchambre`) FROM `chambre` WHERE 1");
...
echo "INSERT INTO `chambre` (`numchambre`, `numhotel`, `etage`, `typechmbre`, `prixnuit`) VALUES ('$numchambre', '$numhotel', '$etage', \"$type\", '$prix');";
$qry=mysqli_query($con,"INSERT INTO `chambre` (`numchambre`, `numhotel`, `etage`, `typechmbre`, `prixnuit`) VALUES ('$numchambre', '$numhotel', '$etage', \"$type\", '$prix');");
