...
$v2=  mysqli_query($con,"SELECT MAX(`num_client`) FROM `client` WHERE 1");
...
echo "INSERT INTO `chambre` (`numchambre`, `numhotel`, `etage`, `typechmbre`, `prixnuit`) VALUES ('$numcilent', \"$nom\", \"$prenom\"); ";
$qry=mysqli_query($con,"INSERT INTO `client` (`num_client`, `nom`, `prenom`) VALUES ('$numcilent', \"$nom\", \"$prenom\");");
