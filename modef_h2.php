...
$v2= mysqli_query($con,"UPDATE `hotel` SET `nom` = '$hotel', `ville` = '$ville', `etoiles` = '$etoil' WHERE `hotel`.`numhotel` = $numhotel");
  
if ($v2){
    echo "UPDATE `hotel` SET `nom` = '$hotel', `ville` = '$ville', `etoiles` = '$etoil' WHERE `hotel`.`numhotel` = $numhotel";
