              ...
              <ul class="sidebar-menu">                
                  ...
                  <li >
                       <a class="" href="requet8.php">
                          <span>Supprimer toutes les 􀄐ha􀅵􀄏􀆌es de l’hôtel "Renaissance". Quels sont les problèmes rencontrés.</span>
                      </a>
                  </li>
                   <li >
                       <a class="" href="j1.php">
                          <span>- Lister tous les hôtels d’u􀅶e ville donnée en paramètre.</span>
                      </a>
                  </li>
                                     <li >
                       <a class="" href="j12.php">
                          <span>Tous les clients pour un type de chambre donnée pour un hôtel donné..</span>
                      </a>
                  </li>
...
//$query=  mysqli_query($con,"SELECT * FROM `sanse`");  
 mysqli_query($con,"DELETE FROM `reservation`  WHERE `numhotel`=(SELECT  numhotel FROM `hotel` WHERE nom='Renaissance')");
 mysqli_query($con,"DELETE FROM `chambre` WHERE `numhotel`=(SELECT  numhotel FROM `hotel` WHERE nom='Renaissance')");
 mysqli_query($con,"DELETE FROM `hotel` WHERE nom='Renaissance'");
