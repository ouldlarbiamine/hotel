...
$query=  mysqli_query($con,"SELECT * FROM `reservation` WHERE 1");
//`numclient``numhotel``datearivee``datedepart``numchambre`
$i2=0;                
//  oierient les etudient  choizi
  
echo "<table border=\"1\"  >";
     //   echo "<caption>  </caption>";
        echo "<tr><td>numero client</td><td>  numero chambre </td><td>numero hotel  </td> <td>datearivee </td> <td>datedepart</td> <td>action</td></tr>";
     
while ($row= mysqli_fetch_assoc($query)) {//1
    //`numhotel``ville``nom``etoiles`
    $numchambre=$row['numchambre']; $numhotel=$row['numhotel'];  
     $numcl=$row['numclient'];
     $datearivee=$row['datearivee'];
     $datedepart=$row['datedepart'];
     $num1=$numchambre;
     $num2=$numhotel;
 echo "<tr><td>$numcl</td><td>  $numchambre </td><td>$numhotel  </td> <td>$datearivee</td><td>$datedepart</td> <td>"
. " <div class=\"btn-group\"><a class=\"btn btn-primary\"   href=\"modef_r.php?ch=$numchambre&hotel=$numhotel&typechmbre=$numcl&prixnuit=$datedepart&etage=$datearivee\"><i class=\"icon_check_alt2\"  ></i>modefier</a> "
. "    <a class=\"btn btn-danger\"   href=\"sup_r.php?numchambre=$numchambre&numhotel=$numhotel\"><i class=\"icon_close_alt2\"  ></i>&nbspsuprimier</a> ";
