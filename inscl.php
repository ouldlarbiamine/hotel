          ...
          <section class="wrapper">
              ...
              <header class="panel-heading">
                          ...
                          <div class="panel-body">
                              <div class="form">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="inscl2.php" novalidate="novalidate">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="pr" minlength="5" type="text" required="">
                                          </div>
