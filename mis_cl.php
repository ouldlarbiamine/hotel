...
$query=  mysqli_query($con,"SELECT * FROM `client` WHERE 1");
...
echo "<table border=\"1\"  >";
     //   echo "<caption>  </caption>";
        echo "<tr><td>  num  </td><td>nom  </td> <td>prenom</td> <<td>action</td> </tr>";
...
while ($row= mysqli_fetch_assoc($query)) {//1
    $nom=$row['nom']; $num2=$row['num_client'];  
     ...
     $num1=$num2;
                                                 ...
                                                 echo "<tr><td>  $num2 </td><td>$nom  </td> <td>$pr</td> <td>"
. " <div class=\"btn-group\"><a class=\"btn btn-primary\"   href=\"modef_cl.php?fr=$num2&nom=$nom&prenom=$pr\"><i class=\"icon_check_alt2\"  ></i>modefier</a> "
. "    <a class=\"btn btn-danger\"   href=\"sup_cl.php?fr=$num2&rb=$num1\"><i class=\"icon_close_alt2\"  ></i>&nbspsuprimier</a> ";
