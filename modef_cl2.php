...
<section id="main-content">
          <section class="wrapper">  
                 ...
                 <?php
include 'conect.php';
$numcli=$_SESSION['numcl'];

$nom=$_POST['nom'];
$prenom=$_POST['pr'];
           
$v2= mysqli_query($con,"UPDATE `client` SET `num_client` = '$numcli', `nom` = '$nom', `prenom` = '$prenom' WHERE `client`.`num_client` =$numcli");

  
if ($v2){
    echo "UPDATE `client` SET `num_client` = '$numcli', `nom` = '$nom', `prenom` = '$prenom' WHERE `client`.`num_client` =$numcli";
