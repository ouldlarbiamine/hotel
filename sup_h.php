...
$v1= mysqli_query($con,"DELETE FROM `chambre` WHERE `numhotel`=$num");
if ($v1){
 $v2= mysqli_query($con,"DELETE FROM `hotel` WHERE `hotel`.`numhotel` = $num");

  
if ($v2){
  echo "DELETE FROM `hotel` WHERE `hotel`.`numhotel` =$num";
